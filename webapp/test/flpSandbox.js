		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commindsetproject7-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetproject7-display": {
								"semanticObject": "commindsetproject7",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.project7",
									"url": sap.ui.require.toUrl("com/mindset/project7")
								}
							}
						}
					}
